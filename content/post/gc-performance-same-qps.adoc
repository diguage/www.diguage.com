...
image::/images/gc-performance/jvm-cpu-max.jpg[title="CPU 使用率（Max）",alt="CPU 使用率（Max）",{image_attr}]

image::/images/gc-performance/jvm-cpu-min.jpg[title="CPU 使用率（Min）",alt="CPU 使用率（Min）",{image_attr}]
